document.addEventListener("DOMContentLoaded", () => {
    ...
    const setFeedback = (input, isValid, errorMessage, iconId) => {
        ...
        if (isValid) {
            ...
            iconElement.classList.add("bg-[url('tickmark.svg')]");
            iconElement.classList.remove("bg-[url('xmark.svg')]");
        } else {
            input.classList.add("border-red-500");
            input.classList.remove("border-green-500");
            errorElement.textContent = errorMessage;
            iconElement.classList.add("bg-[url('xmark.svg')]");
            iconElement.classList.remove("bg-[url('tickmark.svg')]");
        }
    };
